<?php $__env->startSection('title', 'Products - MMS Connections'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card group hover:scale-105">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-3"><?php echo e($product['name']); ?></h3>
                        <p class="text-gray-600 mb-4"><?php echo e($product['description']); ?></p>

                        <div class="mb-6">
                            <div class="text-3xl font-bold text-sky-600 mb-4"><?php echo e($product['price']); ?></div>
                            <div class="space-y-2">
                        ...
                        <a href="<?php echo e(route('product-detail', $product['slug'])); ?>" class="btn-primary w-full text-center block">
                            Learn More
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="<?php echo e(route('contact-us')); ?>" class="btn-primary inline-block">
                Get in Touch
            </a>
        </div>
    </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/hhz/Desktop/teaching/mms-connections-resources/05-laravel-blade/resources/views/products.blade.php ENDPATH**/ ?>