<?php $__env->startSection('title', 'Home - MMS Connections'); ?>
    ...
    <section class="py-20 gradient-light">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(route('our-services')); ?>" class="btn-primary inline-block">
                    View All Services
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/hhz/Desktop/teaching/mms-connections-resources/05-laravel-blade/resources/views/home.blade.php ENDPATH**/ ?>